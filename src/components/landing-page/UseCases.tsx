      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {useCases.map((useCase, idx) => (
            <div key={idx} className="group flex flex-col gap-8 p-10 rounded-[48px] bg-zinc-50 border border-transparent hover:border-brand-lime/20 hover:bg-brand-lime/5 hover:shadow-2xl hover:shadow-brand-lime/10 transition-all duration-700">
               <div className="w-20 h-20 bg-white shadow-xl rounded-[28px] flex items-center justify-center text-neutral-900 group-hover:scale-110 transition-transform duration-700 group-hover:bg-brand-lime group-hover:text-neutral-900">
                  {useCase.icon}
               </div>
               <div className="flex flex-col gap-4">
                  <h4 className="text-2xl font-bold font-manrope text-neutral-900 group-hover:text-brand-lime transition-colors">
                    {useCase.title}
                  </h4>
               ...
               <div className="mt-4 pt-6 border-t border-zinc-200 group-hover:border-brand-lime/20 transition-colors">
                  <span className="text-sm font-bold font-manrope uppercase tracking-widest text-neutral-900 group-hover:text-brand-lime">Explore Solution</span>
               </div>
            </div>
          ))}
        </div>
