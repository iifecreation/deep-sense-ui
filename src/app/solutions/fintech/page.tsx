  ...
  return (
    <div className="min-h-screen bg-white font-manrope">
      ...
      <main className="pt-40 pb-24 overflow-hidden">
        ...
        <section className="max-w-[1440px] mx-auto px-8 mb-32 relative text-center">
          ...
          <div className="max-w-[1100px] mx-auto relative z-10 text-center">
             <div className="inline-flex items-center gap-2 px-3 py-1 bg-neutral-900 rounded-full text-brand-lime text-[11px] font-bold uppercase tracking-widest mb-10 shadow-2xl">
               ...
               High-Velocity Fraud Intelligence
             </div>
             <h1 className="text-6xl lg:text-9xl font-bold leading-[0.95] mb-10 tracking-tight text-neutral-900 uppercase italic">
               Fraud Intelligence for <br />
               <span className="text-zinc-300 italic">Modern Fintech.</span>
             </h1>
             <p className="text-xl text-zinc-500 font-inter leading-relaxed max-w-[800px] mx-auto mb-14">
                Deep Sense empowers high-growth fintechs to build secure products with real-time fraud detection that scales with your volume and speed.
             </p>
        ...
        {/* 2. THE PROBLEM (FINTECH CHALLENGES) */}
        <section className="py-24 bg-neutral-900 text-white rounded-[100px] mx-4 overflow-hidden relative border border-white/5 shadow-3xl">
           ...
           <div className="max-w-[1440px] mx-auto px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
              <div className="space-y-12">
                 <h2 className="text-4xl lg:text-7xl font-bold uppercase italic tracking-tighter leading-tight underline decoration-brand-lime decoration-8 underline-offset-16 font-manrope">Hyper-Growth Risk.</h2>
                 <p className="text-xl text-white/40 font-inter italic max-w-[500px]">Fintechs move fast. Traditional fraud systems are too slow, leading to high false positives and friction that kills conversion.</p>
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    {[
                      { l: "Sophisticated ATO", d: "Bots targeting high-value neobank accounts." },
                      { l: "Synthetic Identity", d: "Fake accounts draining venture capital." },
                      { l: "Payment Velocity", d: "Rapid-fire card testing and exploitation." },
                      { l: "Compliance Burden", d: "Hard-to-scale AML and KYC workflows." }
                    ].map((it, i) => (
                 ...
                 <div className="bg-white/5 p-8 rounded-[40px] border border-white/5">
                    <p className="text-xl font-bold italic text-white leading-relaxed">“Growth shouldn&apos;t come at the cost of security.”</p>
                 </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-12 lg:p-24 rounded-[80px] shadow-3xl group relative overflow-hidden backdrop-blur-xl">
                 <Shield className="w-40 h-40 absolute top-0 right-0 p-12 text-white opacity-5 group-hover:scale-110 transition-transform duration-1000" />
                 <h3 className="text-3xl font-bold italic uppercase tracking-tight mb-8 font-manrope">The Fintech Layer.</h3>
        ...
        <section className="py-40">
           <div className="max-w-[1440px] mx-auto px-8 relative z-10">
              <div className="text-center mb-32 max-w-[800px] mx-auto">
                 <h2 className="text-4xl lg:text-7xl font-bold uppercase italic tracking-tighter mb-8 font-manrope text-neutral-900 underline decoration-zinc-100 decoration-8 underline-offset-16">Fintech Core.</h2>
                 <p className="text-xl text-zinc-500 font-inter italic max-w-[600px] mx-auto">Specific solutions designed to protect the modern fintech lifecycle.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                 {[
                   ...
                   { l: "API-First Security", d: "Protect every endpoint from bot exploitation.", i: <Rocket /> }
                 ].map((it, i) => (
        ...
        <section className="py-40 bg-zinc-50 border-y border-gray-100">
           <div className="max-w-[1440px] mx-auto px-8 text-center">
              <h2 className="text-4xl lg:text-7xl font-bold uppercase italic tracking-tighter mb-24 font-manrope text-neutral-900 underline decoration-zinc-100 decoration-8 underline-offset-16 text-center mx-auto max-w-[800px]">Velocity & Scalability.</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                 {[
                   { v: "300%", l: "Reduction in Fraud Loss", i: <TrendingUp /> },
                   { v: "<45ms", l: "Average Scoring Latency", i: <Zap /> },
                   { v: "99.9%", l: "Decision Accuracy", i: <Activity /> }
                 ].map((m, i) => (
        ...
        <section className="max-w-[1300px] mx-auto px-4 mb-24 mt-24 text-center">
           <div className="bg-neutral-900 rounded-[80px] p-12 md:p-32 relative overflow-hidden group border border-white/10 shadow-3xl">
              ...
              <div className="relative z-10 space-y-12">
                 ...
                 <p className="text-xl md:text-2xl mb-12 max-w-[600px] mx-auto opacity-70 tracking-tight leading-relaxed font-manrope italic text-white">Experience the full power of Deep Sense for your fintech ecosystem.</p>
