        ...
        <section className="py-32 px-8">
          <div className="max-w-[1440px] mx-auto text-center flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 text-left">
              {[
                { title: "Alert Management", desc: "Real-time alert sorting and prioritization.", icon: <BellIcon /> },
                ...
                { title: "Reporting Integration", desc: "Seamless conversion from case to STR/SAR.", icon: <FileTextIcon /> },
           ...
           <div className="max-w-[1440px] mx-auto relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-6 gap-8 relative">
                 {[
                   ...
                   { l: "Alert", s: "Generated in UI", i: <BellIcon /> },
                   ...
                   { l: "Report", s: "Filing generated", i: <FileTextIcon /> }
                 ].map((it, i) => (
